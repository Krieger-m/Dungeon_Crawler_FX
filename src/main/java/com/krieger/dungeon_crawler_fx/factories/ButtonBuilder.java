...
public class ButtonBuilder extends App {
    ...
    public ArrayList<String> btnNames= new ArrayList<>();
    ...
    public ButtonBuilder() {
        btnNames.addAll(List.of(new String[]{"Search", "Action", "Inventory"}));
    }
    ...
    public void createNewButtons(){
        for (String s : this.btnNames) {
            System.out.println("button "+s+" added");
            PaneFactory.btnList.add(returnNewBtn(s));
        }
    }
